...
do
    ...
    do
	echo $r ;
	newpf=params_all_mc_array_spin_v_spincommonfixgamma_${delta}_20210803_r${real}.dat
	cp params_all_mc_array_spin_v_spincommonfixgamma_DP0_DALPHA_20210803_rN.dat $newpf;
