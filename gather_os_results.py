...
plot_matrix(m_os_matrix, norm = matplotlib.colors.LogNorm(), measure = 'A', label = 'mp')
plot_matrix(m_os_marg_matrix, norm = matplotlib.colors.LogNorm(), measure = 'A', label = 'marg_mp')
plot_matrix(m_os_snr_matrix, measure = 'S/N', label = 'mp')
plot_matrix(m_os_marg_snr_matrix, measure = 'S/N', label = 'marg_mp')
