...
logfile="slurm_logs/gwb_crn_sims_mc_spin_v_spincommon_noise_range_20210803_53974924_${SLURM_ARRAY_TASK_ID}.log"

if grep -Fxq "$logfile" completed_runs.txt
then
  echo $SLURM_ARRAY_TASK_ID already finished
else
  #doing the main run
